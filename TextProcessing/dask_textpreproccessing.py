...
training_data_untagged = dd.read_csv(
    "/home/will/Computerscience/Machinelearning/Projects/Toxicspeechspot/Programdata/train.csv", skip_blank_lines=True,error_bad_lines=False)
train_name = ("train_tagged")
training_data_untagged.head()

print("\nTraining data has been loaded")

# importing testing data
testing_data_untagged = dd.read_csv(
    "/home/will/Computerscience/Machinelearning/Projects/Toxicspeechspot/Programdata/test.csv")
test_name = ("test_tagged")
testing_data_untagged.head()
...
def vectorising(comment_text):

    #new_csv = dd.read_csv('/home/will/Computerscience/Machinelearning/Projects/Toxicspeechspot/Toxic_Speech_Spot/TextProcessing/headers.csv')
    ...
    return comment_text_vectorised
    
testing_data_untagged['comment_text'].apply(vectorising)
testing_data_untagged.head()

training_data_untagged['comment_text'].apply(vectorising)
training_data_untagged.head()
   ...
   # new_csv.to_csv(
    #    "/home/will/Computerscience/Machinelearning/Projects/Toxicspeechspot/Programdata/{0}/{0}.csv".format(
     #       name,
